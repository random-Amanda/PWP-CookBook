...
class ApiKey(db.Model):
    ...
    key = db.Column(db.String(500), primary_key=True, autoincrement=False)
    ...
    def serialize(self):
        """
        Serialize the Api key object to a dictionary.
        """
        return {
            "key": self.key,
            "admin": self.admin
    ...
    def get_schema():
        """
        Get the JSON schema for the Api key model.
        """
        return {
            "type": "object",
            "properties": {
